          ...
          <Box sx={estilobox}>
            <form onSubmit={onSubmitEmail}>
              <Grid container spacing={1}>
                ...
                <Grid item xs={12}>
                  <TextField required disabled size="small" fullWidth label="Nombre" value={formularioemail.nombre} />
                </Grid>
                <Grid item xs={12}>
                  <TextField
                    required
              ...
              <form onSubmit={onSubmit}>
                <Grid container spacing={1} sx={{ mb: 1 }}>
                  ...
                  <Grid item md={2} sm={6} xs={12}>
                    ...
                    >
                      {operador.map((m) => (
                        <MenuItem key={m.idoperador} value={m.idoperador}>
                          {m.nombre}
                        </MenuItem>
                      ))}
                    </TextField>
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) => {
                            setFiltroperador(e.target.checked);
                          }}
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) => {
                            setEnviadoCorreo(e.target.checked);
                          }}
                        />
                      }
                      label="Enviados por correo"
                    />
                  </Grid>
