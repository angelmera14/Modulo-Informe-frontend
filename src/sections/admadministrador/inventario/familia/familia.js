...
export default function Homecategoria() {
  ...
  const columns = [
    ...
    { field: 'nombre', headerName: 'Nombre', width: 300, editable: true, cellClassName: 'amarillo' },
    {
      field: 'estado',
      headerName: 'Estado',
      width: 100,
    ...
    { field: 'categoria', headerName: 'Categoría', width: 110, editable: true, hide: true, cellClassName: 'blueCell' },
    {
  ...
  const Edit = (e) => {
    navegacion(`/sistema/inventario/editarfamilia`, { state: { id: e.id } });
  };
              ...
              <HeaderBreadcrumbs
                ...
                action={
                  <Button
                    ...
                    to="/sistema/inventario/nuevafamilia"
                      ...
                      <Grid container justifyContent="flex-end" direction="row">
                        <Grid item md={2} sm={2} xs={12}>
                          <Button
                            ...
                            href={`${URLAPIGENERAL}/familia/generarexcel`}
                          >
                            Excel
                          </Button>
                        </Grid>
                        <Grid item md={2} sm={2} xs={12}>
                          <Button
                            ...
                            href={`${URLAPIGENERAL}/familia/generarpdf`}
                            target="_blank"
                          >
                            PDF
                          </Button>
