...
export default function Homecategoria() {
  ...
  const Edit = (e) => {
    navegacion(`/sistema/inventario/editarcategoria`, { state: { id: e.id } });
  };
  ...
  React.useEffect(() => {
    async function getDatos() {
      try {
        const { data } = await axios(
          `${URLAPIGENERAL}/categorias/listar`,
          {
            headers: {
    ...
    //   const { data } = await axios(`${URLAPILOCAL}/categorias/listar`);
    // }
    getDatos();
    // obtenerUrl();
  }, []);
              ...
              <HeaderBreadcrumbs
                ...
                action={
                  <Button
                    ...
                    to="/sistema/inventario/nuevacategoria"
                      ...
                      <Grid container justifyContent="flex-end" direction="row">
                        <Grid item md={2} sm={2} xs={12}>
                          <Button
                            ...
                            href={`${URLAPIGENERAL}/categorias/generarexcel`}
                          >
                            Excel
                          </Button>
                        </Grid>
                        <Grid item md={2} sm={2} xs={12}>
                          <Button
                            ...
                            href={`${URLAPIGENERAL}/categorias/generarpdf`}
                            target="_blank"
                          >
                            PDF
                          </Button>
