...
export default function Homepresetacion() {
  ...
  const Edit = (e) => {
    navegacion(`/sistema/inventario/editarpresentacion`, { state: { id: e.id } });
  };
    ...
    async function getDatos() {
      try {
        const { data } = await axios(
          `${URLAPIGENERAL}/presentaciones/listar`,
          {
            headers: {
              ...
              <HeaderBreadcrumbs
                ...
                action={
                  <Button
                    ...
                    to="/sistema/inventario/nuevapresentacion"
                      ...
                      <Grid container justifyContent="flex-end" direction="row">
                        <Grid item md={2} sm={2} xs={12}>
                          <Button
                            ...
                            href={`${URLAPIGENERAL}/presentaciones/generarexcel`}
                          //  href="https://localhost:7053/api/presetacion/generarexcel"
                          >
                            Excel
                          </Button>
                        </Grid>
                        <Grid item md={2} sm={2} xs={12}>
                          <Button
                            ...
                            href={`${URLAPIGENERAL}/presentaciones/generarpdf`}
                            // href="https://localhost:7053/api/presetacion/generarpdf"
                            target="_blank"
                          >
                            PDF
                          </Button>
